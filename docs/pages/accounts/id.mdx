...
| ------------- | ------ | -------- | ----------------------------------------------------------------------------------------------- |
| x-api-key     | string | Optional | Your Recoup API key. See [Getting Started](/getting-started) for how to create and manage keys. |
...
```bash [cURL]
curl -X GET "https://api.recoupable.com/api/accounts/id" \
...
async function getAccountId() {
  const response = await fetch("https://api.recoupable.com/api/accounts/id", {
    headers: {
