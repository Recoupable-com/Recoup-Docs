...
# result = create_conversation(artist_id="1873859c-dd37-4e9a-9bac-80d35a1b2c3d")
```
...
// const result = await createConversation({ artistId: "1873859c-dd37-4e9a-9bac-80d35a1b2c3d" });
```
...
| artist_id  | string | UUID of the associated artist (null if not provided)     |
