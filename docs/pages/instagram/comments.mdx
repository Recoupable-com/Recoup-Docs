...
def get_instagram_comments(post_urls, results_limit=10000, is_newest_comments=True):
...
async function getInstagramComments(postUrls, resultsLimit = 10000, isNewestComments = true) {
